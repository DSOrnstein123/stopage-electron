...
func (q *Queries) GetFlashcardsInDeck(ctx context.Context, id uuid.UUID) ([]Flashcard, error) {
...
func (q *Queries) InsertDeck(ctx context.Context, arg InsertDeckParams) (Deck, error) {
	row := q.db.QueryRowContext(ctx, insertDeck, arg.ID, arg.Name, arg.ParentID)
	var i Deck
	err := row.Scan(&i.ID, &i.Name, &i.ParentID)
	return i, err
}
